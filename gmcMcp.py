...
if len(sys.argv) < 7:
    print 'gmcMcp: not enough parameter!'
    print '\tUsage: gmcMcp.py dir_name base_name nproc range start end'
    print '\tExample: gmcMcp.py MCT-1 dwarf 4 60.0 0 20'
    sys.exit(1)
...
#        mp_snap_mc.gen_snap_den(rarr, dir_name, base_name, snap_num, size, \
#            title_name = title)
