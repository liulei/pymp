...
def calc_r_O(arr, nbin, rad):

# assume initial oxygen of -2 relative to solar value

    zini = 8.9 - 12.0 + np.log10(5E-4 / 0.02)
    zini = 16.0 * np.power(10.0, zini)
...
if len(sys.argv) < 5:
	print 'col_RO: not enough parameter!'
	print '\tUsage: col_RO.py dir_name base_name nproc size'
	print '\tExample: col_RO.py MW-11.1 MW 8'
	sys.exit(1)
...
rb, zwb, zcb, zsb = calc_r_O(arr, nbin, rsize)
