...
if len(sys.argv) < 6:
    print 'obsHistRNOp.py: not enough parameter!'
    print '\tUsage: obsHistRNOp.py dir_name base_name nproc snap_num rsize'
    print '\tExample: obsHistRNOp.py MW-hd-2 MW 8 0006 10.0'
    sys.exit(0)
...
figure_name = 'Obs-Hist-R-NO-%s-%s.png' % (dir_name, snap_num)
