...
def gen_Mc_surface_den(arr, dir_name, base_name, snap_num, size, title_name = ''):

    ids = np.where(arr['type'] == mp.TYPE_COLD)
...
############################## mass density ##############################
    ...
    plt.xlim(0, size)
    figure_name = 'Mc-R-rho-' + dir_name + '-' + snap_num + '.png'
...
#for i in range(start, end + 1):
    ...
    gen_Mc_surface_den(rarr, dir_name, base_name, snap_num, size, title_name = title)
