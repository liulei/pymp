...
if len(sys.argv) < 2:
    ...
    mass_name = 'mass.dat'
    figure_base = 'Mass-evolve'
else:
    mass_name = 'mass_%.1fkpc.dat' % float(sys.argv[1])
    figure_base = 'Mass-evolve-%.1fkpc' % float(sys.argv[1])
...
dir = ['Simple-81-1', 'Simple-80-1', 'Simple-91-1', 'Simple-90-1', 'Simple-101-1', 'Simple-100-1']
...
figure_name = figure_base + '.png'
plt.savefig(figure_name)

figure_name = figure_base + '.eps'
plt.savefig(figure_name)
