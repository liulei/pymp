...
plt.plot(xt, count, 'b-', label = 'Type SNII', drawstyle = 'steps-mid')

xt, count = calc_hist_FB(tsn1, nbin, tmax)
plt.plot(xt, count, 'r-', label = 'Type SNIa', drawstyle = 'steps-mid')

xt, count = calc_hist_FB(tpn, nbin, tmax)
plt.plot(xt, count, 'g-', label = 'Type PN', drawstyle = 'steps-mid')
