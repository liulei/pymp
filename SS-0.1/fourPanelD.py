...
if len(sys.argv) < 5:
    ...
    print '\tUsage: ./fourPanelD.py dir_name base_name nproc box_size'
    print '\tExample: ./DPanel.py SS-5E7-iso-4 dwarf 16 7.0'
    sys.exit(1)
...
snap_num = ['0010', '0020', '0050', '0100']

multi_den(dir_name, base_name, nproc, size, snap_num)
